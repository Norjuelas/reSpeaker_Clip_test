...
/* Render battery %, charge/discharge state (+ cycle count), voltage, and
 * temperature. Four 6x12 lines fill the 88x48 OLED (y = 0/12/24/36). */
		       ...
		       const char *state, uint32_t cycles)
{
	...
	/* Line 4: battery temperature (NTC) */
