...
/**
 * @brief Send LC3 frame via BLE notification
 *
 * @param data LC3 encoded data
 * @param len Length of data (max MTU-3 bytes)
 * @return 0 on success, negative error code on failure
 */
int ble_send_lc3_frame(const uint8_t *data, uint16_t len);
